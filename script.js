...
const usuarios = [
    ...
    { usuario: 'Patrick.santos',   senha: '2510',   perfil: 'admin', nome: 'Patrick'   },
    { usuario: 'Moises.santos',    senha: '2510',   perfil: 'admin', nome: 'Moises'    },
    { usuario: 'Enzo.santos',      senha: '2510',   perfil: 'membro', nome: 'Enzo'      },
    { usuario: 'Alesio.santos',    senha: '2510',   perfil: 'membro', nome: 'Alesio'    },
    { usuario: 'Douglas.santos',   senha: '2510',   perfil: 'membro', nome: 'Douglas'   },
    { usuario: 'Edilane.santos',   senha: '2510',   perfil: 'membro', nome: 'Edilane'   },
    { usuario: 'Joao.santos',      senha: '2510',   perfil: 'membro', nome: 'Joao'      },
    { usuario: 'Larrisa.santos',   senha: '2510',   perfil: 'membro', nome: 'Larrisa'   },
    { usuario: 'Miguel.santos',    senha: '2510',   perfil: 'membro', nome: 'Miguel'    },
    { usuario: 'Nicole.santos',    senha: '2510',   perfil: 'membro', nome: 'Nicole'    },
    { usuario: 'Vanessa.santos',   senha: '2510',   perfil: 'membro', nome: 'Vanessa'   },
    { usuario: 'Vitoria.santos',   senha: '2510',   perfil: 'membro', nome: 'Vitoria'   },
    { usuario: 'Wagao.santos',     senha: '2510',   perfil: 'membro', nome: 'Wagao'     },
    { usuario: 'Eliane.santos',    senha: '2510',   perfil: 'membro', nome: 'Eliane'    },
    { usuario: 'Erika.santos',     senha: '2510',   perfil: 'membro', nome: 'Erika'     },
];
